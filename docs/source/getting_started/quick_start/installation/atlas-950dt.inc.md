=== "950DT"
    ...
    The following command starts a single-card 950DT container using `/dev/davinci0` for the inference service in the next section. Before running the command, make sure that this device node exists on the host.
