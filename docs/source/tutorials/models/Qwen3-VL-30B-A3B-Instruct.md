...
- `Qwen3-VL-30B-A3B-Instruct-w8a8-mxfp8` (quantized version): requires one 950DT series product (96G x 8 NPUs). [Model Weight](https://modelscope.cn/models/Eco-Tech/Qwen3-VL-30B-A3B-Instruct-w8a8-mxfp8)
...
=== "950DT"
    ...
    Run the following script to execute online inference on one 950DT series product (96G x 8 NPUs). The quantized version (`Qwen3-VL-30B-A3B-Instruct-w8a8-mxfp8`) can be deployed on a single 950DT series product. The W8A8 version needs `--quantization ascend`.
