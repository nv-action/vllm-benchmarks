...
EXECUTION_MODE = {
    "Qwen/Qwen3-8B-Base": "graph",
    "Qwen/Qwen2.5-VL-7B-Instruct": "graph",
    "Qwen/Qwen3-30B-A3B": "graph"
}
MODEL_ARGS = {
    ...
    "Qwen/Qwen2.5-VL-7B-Instruct": "pretrained=Qwen/Qwen2.5-VL-7B-Instruct,max_model_len=8192,dtype=auto,tensor_parallel_size=4,max_images=2",
...
**Parallel Mode**: {PARALLEL_MODE[model]}
**Execution Mode**: {EXECUTION_MODE[model]}
**Command**:  
```bash
{run_cmd}
```
