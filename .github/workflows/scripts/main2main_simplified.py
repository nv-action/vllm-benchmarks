    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "test failures log is available at /tmp/main2main-test.log",
            "",
            "Context:",
            f"- Benchmark repo is checked out at ./{work_repo_dir}",
            f"- Upstream vLLM source is checked out at ./{vllm_dir}",
            ...
            "- Main2Main test log path=/tmp/main2main-test.log",
            "",
            "Requirements:",
            "- Use /tmp/main2main-test.log as the primary failure-analysis input",
    ...
    *,
    ...
    return "\n".join(
        [
            ...
            f"- Upstream vLLM source is checked out at ./{vllm_dir}",
            "- Main2Main test log path=/tmp/main2main-test.log",
            f"- Bisect result path=/tmp/bisect_output_round{round_index}/bisect_result.json",
            f"- Round={round_index}",
            f"- OLD_COMMIT={old_commit}",
            f"- NEW_COMMIT={new_commit}",
            "",
