...
# Import CompilationTimes with backward compatibility
# Upstream commit c08f3b2a62 changed compile_or_warm_up_model return type from float to CompilationTimes
if not vllm_version_is("v0.19.0"):
...
class NPUWorker(WorkerBase):
    ...
    def compile_or_warm_up_model(self):
        ...
        set_random_seed(self.model_config.seed)
        compilation_time = self.vllm_config.compilation_config.compilation_time
