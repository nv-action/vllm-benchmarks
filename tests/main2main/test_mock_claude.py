...
def test_mock_claude_success_detect_rewrites_old_commit_and_creates_summary(tmp_path):
    ...
    old_commit = "18b1c77211d8f6fe800bcfb89524d2b598708032"
    ...
    env.update(
        {
            ...
            "MOCK_CLAUDE_SUMMARY_PATH": str(tmp_path / "main2main-failure-summary.json"),
        }
    )
    ...
    summary = json.loads((tmp_path / "main2main-failure-summary.json").read_text(encoding="utf-8"))
    assert summary["good_commit"] == old_commit
    assert summary["bad_commit"] == new_commit
