...
**Commit range:** `a40ee486f273eaaa885dafd0526f42f3a5b960c9`...`4ff8c3c8f9ece010a1d0e376f5cc1b468b95f366`
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        result = subprocess.run(
            [
                ...
                "abc123",
                "--old-commit",
                "a40ee486f273eaaa885dafd0526f42f3a5b960c9",
                "--new-commit",
        ...
        return json_dumps(
            {
                ...
                "body": (
                    "## Summary\n\n"
                    "**Commit range:** `a40ee486f273eaaa885dafd0526f42f3a5b960c9`..."
                    "`4ff8c3c8f9ece010a1d0e376f5cc1b468b95f366`\n"
                ),
...
def test_reconcile_dispatch_fixup_marks_state_fixing_with_run_id():
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        class FakeGitHub:
            ...
            def find_latest_fixup_run(self, *, repo, branch, head_sha):
                return {
                    "run_id": "200",
                    "status": "queued",
...
class FakeGitHubAdapter:
    ...
    def find_latest_fixup_run(self, *, repo, branch, head_sha):
        self.calls.append(("find_latest_fixup_run", repo, branch, head_sha))
        return {
            "run_id": "fixup-1",
            "status": "queued",
            "conclusion": "",
