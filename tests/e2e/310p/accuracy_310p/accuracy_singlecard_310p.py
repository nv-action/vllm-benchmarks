...
# MODEL_NAME = ["Qwen/Qwen3-0.6B", "Qwen/Qwen2.5-7B-Instruct"]
...
def run_test(queue, model, max_model_len, model_type):
    try:
        model_args = (
    f"pretrained={model},max_model_len={max_model_len},"
    "tensor_parallel_size=1,dtype=auto,compilation_config="
